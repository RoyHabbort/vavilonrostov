<div class="content-width page-admin">
    ...
    <div class="admin-title block-padding">
        ...
        <div>
            <form method='post' action='/heretic/deletePage/<?=$arguments['result']['id_page']?>/'>
    ...
    <div class="admin-page-block block-padding edit-page">
        ...
        <form  action="/heretic/editPage/<?=$arguments['result']['id_page']?>/<?=$arguments['result']['page_type']?>"  method="post" name="page-edit-material" class="edit-form" enctype="multipart/form-data">
