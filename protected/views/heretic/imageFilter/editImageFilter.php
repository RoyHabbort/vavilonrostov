<div class="content-width page-admin">
    ...
    <div class="admin-title block-padding">
        ...
        <div>
            <form method='post' action='/heretic/deleteImageFilter/<?=$arguments['result']['id_image_filter']?>/'>
    ...
    <div class="admin-page-block block-padding edit-page">
        ...
        <form  action="/heretic/editImageFilter/<?=$arguments['result']['id_image_filter']?>"  method="post" name="edit-form" class="edit-form" enctype="multipart/form-data">
