<div class="row">
    <div class="content-width page-admin">
        ...
        <div class="admin-page-block block-padding edit-page">
            ...
            <form  action="/admin/editPromo/<?=$arguments['result']['id_page']?>/<?=$arguments['result']['page_type']?>"  method="post" name="page-edit-material" class="edit-form" enctype="multipart/form-data">
