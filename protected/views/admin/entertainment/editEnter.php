<div class="row">
    <div class="content-width page-admin">
        ...
        <div class="admin-title block-padding">
            Редактирование развлечения &laquo;<?=$arguments['result']['title'];?>&raquo;
        </div>    
        ...
        <div class="admin-page-block block-padding edit-page">
            ...
            <form  action="/admin/editEnter/<?=$arguments['result']['id_page']?>/<?=$arguments['result']['page_type']?>"  method="post" name="page-edit-material" class="edit-form" enctype="multipart/form-data">
