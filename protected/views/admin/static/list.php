<div class="row">
    <div class="content-width page-admin">
        ...
        <div class="admin-title block-padding">
            <div>Редактирование статичных страниц</div>
        </div>    
                ...
                <table class="table">
                    ...
                    <?php foreach ($arguments['result'] as $key => $value) : ?>
                        <tr>
                            ...
                            <td>/<?=$value['link']?></td>
                            <td class="edit-tools">
                                <a href="/admin/editStatic/<?=$value['id_page']?>/<?=$value['page_type']?>"
                                   ><i class="glyphicon glyphicon-pencil"></i>
                                </a>
                                <a href="/admin/delete/<?=$value['id_page']?>/staticPage" onClick="return confirm('Вы уверены в удалении?')">
        ...
        <?php else :?>
            <div class="block-padding">
                В данный момент нет существующих страниц
            </div>    
        <?php endif;?>    
        </div>    
    </div>
